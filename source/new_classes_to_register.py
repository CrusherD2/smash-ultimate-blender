...
classes = [
    ...
    source.updater.prompt.SUB_OP_update_prompt,
    source.updater.prompt.SUB_OP_update_now,
    source.updater.prompt.SUB_OP_update_skip_version,
    source.updater.prompt.SUB_OP_update_clear_skipped,
    source.updater.prompt.SUB_OP_whats_new,
